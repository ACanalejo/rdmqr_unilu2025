...
To help enforcing this policy, students are required to declare the use of AI and specify its scope in an appendix when submitting presentation slides, take-home exercises, and answers to the topic questions.
...
### 4. Answer the topic questions of each session {.unnumbered}
...
- Students must upload their responses to the *Students responses/Topic questions* folder within the specific session folder (e.g., *02_session*) in OLAT. 
...
- The file must be in Word. The title must always follow the structure *topic_questions_sessionXX_YOURSURNAME*.
